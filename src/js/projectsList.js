  ...
  connectedCallback() {
    this.innerHTML = `
      <div class="row p-list-row g-0 p-list-row-first">
        <div class="col-6 small-bold p-list-title"><a href="../portfolio/websitecarbon.html">Website Carbon Poster</a><span class="p-list-date">Graphic Design</span></div>
        <div class="col-5 paragraph">Poster promoting the issue of carbon emissions from websites</div>
        <div class="col-1 small-bold p-list-btn"><a href="../portfolio/websitecarbon.html">VIEW</a></div>
      </div>
      <div class="row p-list-row g-0">
        <div class="col-6 small-bold p-list-title"><a href="../portfolio/voguecover.html">Vogue Magazine Cover</a><span class="p-list-date">Digital Publishing</span></div>
        <div class="col-5 paragraph">Concept Vogue magazine cover about digital design</div>
        <div class="col-1 small-bold p-list-btn"><a href="../portfolio/voguecover.html">VIEW</a></div>
      </div>
      <div class="row p-list-row g-0">
        <div class="col-6 small-bold p-list-title"><a href="../portfolio/coralineremake.html">Coraline Scene Remake</a><span class="p-list-date">Digital Publishing</span></div>
        <div class="col-5 paragraph">Remake of the "Deal" scene from Coraline in real life</div>
        <div class="col-1 small-bold p-list-btn"><a href="../portfolio/coralineremake.html">WATCH</a></div>
      </div>
      <div class="row p-list-row g-0">
