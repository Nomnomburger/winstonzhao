class ProjectList extends HTMLElement {
  ...
  connectedCallback() {
    ...
    <div class="row p-list-row g-0 aBorder p-list-row-first just-fade">
      <div class="col-10 col-xl-6 col-lg-5 small-bold p-list-title"><a href="#">The Drive Team Magazine</a><span class="p-list-date">Upcoming</span></div>
    ...
    <div class="row p-list-row g-0 aBorder just-fade">
      <div class="col-10 col-xl-6 col-lg-5 small-bold p-list-title"><a href="#">Elapse VRC App</a><span class="p-list-date">Upcoming</span></div>
    ...
    <div class="row p-list-row g-0 aBorder just-fade">
      ...
      <div class="col-2 col-lg-1 small-bold p-list-btn"><a href="#">READ</a></div>
    </div>
    <div class="row p-list-row g-0 aBorder just-fade">
      <div class="col-10 col-xl-6 col-lg-5 small-bold p-list-title"><a href="#">The Drive Team Podcast</a><span class="p-list-date">2022</span></div>
    ...
    <div class="row p-list-row g-0 aBorder just-fade">
      <div class="col-10 col-xl-6 col-lg-5 small-bold p-list-title"><a href="#">Team 839 Website</a><span class="p-list-date">2021</span></div>
      <div class="col-0 col-xl-5 col-lg-6 paragraph p-list-desc">Caution Tape Robotics Team 839's website</div>
      <div class="col-2 col-lg-1 small-bold p-list-btn"><a href="#">VISIT</a></div>
    </div>
    <div class="row p-list-row g-0 aBorder just-fade">
      <div class="col-10 col-xl-6 col-lg-5 small-bold p-list-title"><a href="#">Asymtry Logo & Branding</a><span class="p-list-date">2020</span></div>
